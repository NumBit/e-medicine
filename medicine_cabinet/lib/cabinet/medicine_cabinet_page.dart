                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    return StreamBuilder<Object>(
                        stream: CabinetRepository(context)
                            .getDefaultCabinet(snapshot.data.defaultCabinet),
                        initialData: CabinetModel(name: "Loading..."),
                            ...
                            body: CustomScrollView(
                              slivers: [
                                ...
                                /*SliverPadding(
                                                ...
                                                sliver: StreamProvider<List<DrugModel>>.value(
                                                    value: DrugRepository(context,
                                                            Provider.of<CabinetModel>(context).id)
                                                        .streamModels(),
                                                    initialData: [],
                                                    builder: (context, snapshot) {
                                                      return SliverGrid.count(
                                                        ...
                                                        mainAxisSpacing: 15,
                                                        children:
                                                            Provider.of<List<DrugModel>>(context)
                                                                .map((drug) =>
                                                                    Provider<DrugModel>.value(
                                                                        value: drug,
                                                                        child: DrugGridItem()))
                                                                .toList(),
                                                      );
